...
FROM ubuntu:resolute-20251101@sha256:17b7f58eea25af8108b0cbff97a231fe71e0a2ee647221ab2dc7b3b350cca41f AS build
...
FROM ubuntu:resolute-20251101@sha256:17b7f58eea25af8108b0cbff97a231fe71e0a2ee647221ab2dc7b3b350cca41f
SHELL ["/bin/sh", "-exc"]
...
# curl added for healthchecks (QUESTIONABLE)
RUN <<EOT
apt-get update -qy
apt-get install -qyy \
    -o APT::Install-Recommends=false \
